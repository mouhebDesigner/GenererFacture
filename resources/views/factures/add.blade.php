...
<script>
    ...
    function generateServicesTable(response) {
        ...
        services.forEach(function(service, index) {
            ...
            tableHtml += '<tr>';
                ...
                tableHtml += '<td><input type="text" data-required="true" class="form-control prix-ht-input" name="taches[prixHT]['+service.id+'][]" placeholder="Prix HT"></td>';
    ...
    function calculateTotalTTC() {
        ...
        var totalTTC = sousTotal - (sousTotal*remise/100);
